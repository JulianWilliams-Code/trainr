        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FitnessGoals = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    PreferredSport = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CertificationDetails = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_TrainerProfiles_TrainerProfileId",
                        column: x => x.TrainerProfileId,
                        principalTable: "TrainerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_TrainerProfileId_StartTime",
                table: "Availabilities",
                columns: new[] { "TrainerProfileId", "StartTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ClientProfileId_Status",
                table: "Bookings",
                columns: new[] { "ClientProfileId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TrainerProfileId_Status",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerProfiles_SportType",
